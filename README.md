...
![CLOCKWORK wordmark: CLOCK in mauve, WORK in blue, and a gear-shaped O](./assets/clockwork-wordmark.png)
...
Read the [full glossary](./ai-artifacts/CONTEXT.md) for the complete job model.
...
- [Full glossary](./ai-artifacts/CONTEXT.md)
