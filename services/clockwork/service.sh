...
LABEL="${CLOCKWORK_LABEL:-com.iurysouza.clockwork}"
PLIST="${CLOCKWORK_PLIST:-$HOME/Library/LaunchAgents/$LABEL.plist}"
DOMAIN="gui/$(id -u)"
TARGET="$DOMAIN/$LABEL"
TEMPLATE="$SERVICE_DIR/templates/com.iurysouza.clockwork.plist.tpl"
